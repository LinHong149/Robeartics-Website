  ...
  <section className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`}  id="team">
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
      ...
      <div className="w-full md:mt-0 mt-6">
        <motion.p className={`${styles.paragraph} text-left max-w-[450px]`}  initial={{opacity:0}} whileInView={{opacity:1}} viewport={{ once: true, amount: 0.7 }} transition={{ duration: 1, delay: 0.2}}>
